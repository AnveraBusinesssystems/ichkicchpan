...
const labels={en:{nav:['The retreat','Your stay','The lagoon','Gallery'],availability:'Check availability',close:'Close ×'},es:{nav:['El refugio','Tu estancia','La laguna','Galería'],availability:'Ver disponibilidad',close:'Cerrar ×'}};
