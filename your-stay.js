...
const labels={en:{nav:['The retreat','Your stay','The area','Gallery'],availability:'Check availability',close:'Close ×'},es:{nav:['El refugio','Tu estancia','La zona','Galería'],availability:'Ver disponibilidad',close:'Cerrar ×'}};
